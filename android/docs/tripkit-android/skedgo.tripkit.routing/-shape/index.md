[tripkit-android](../../index.md) / [skedgo.tripkit.routing](../index.md) / [Shape](./index.md)
...
| [getStops](get-stops.md) | `open fun getStops(): `[`MutableList`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-mutable-list/index.html)`<`[`ServiceStop`](../../com.skedgo.android.common.model/-service-stop/index.md)`!>?` |
...
| [setStops](set-stops.md) | `open fun setStops(stops: `[`MutableList`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-mutable-list/index.html)`<`[`ServiceStop`](../../com.skedgo.android.common.model/-service-stop/index.md)`!>?): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
